...
/*
--------------------------------------------------------------------------------------------------------------------------------------
Challange: Take input from user in variable a and b, print number of elements present in each variable and then print sum of number of
            elements presenta and b.
            example: 
